...
def get_statistics_filename(
    ...
    statistics_dir = Path('./data') / dataset / 'statistics' / 'masked' / f'{dataset}_{fold}_{split}'
...
def compute_masked_statistics(args):
    ...
    embeddings_filename = get_embeddings_filename('ucf101', 'train', args)
    ...
    statistics_filename = get_statistics_filename('ucf101', 'train', args)
