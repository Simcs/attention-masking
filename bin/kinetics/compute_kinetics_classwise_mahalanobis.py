...
def measure_performances(id_maha, ood_maha):
    ...
    # for _ in range(10):
    for rn in tqdm(random.sample(range(1000), 10)):
...
with open('./data/kinetics/k400_train_statistics_classwise_shrunk.pkl', 'rb') as f:
...
# k400_mahalanobis_distances = k400_mahalanobis_distances / k400_mahalanobis_distances.max(dim=0)
...
with open('./result/ood_scores/video/original/k400_vs_k600_cw_maha.jsonl', 'w') as f:
    f.write(json.dumps({
        'auroc': k600_auroc_score,
        'aupr': k600_aupr_score,
        'fpr95': k600_fpr95,
    }))
save_roc_curve(fpr, tpr, './result/images/k400_vs_k600/cw_maha_auroc.png')
save_precision_recall_curve(pr, re, './result/images/k400_vs_k600/cw_maha_aupr.png')
...
with open('./result/ood_scores/video/original/k400_vs_k700_cw_maha.jsonl', 'w') as f:
    f.write(json.dumps({
        'auroc': k700_auroc_score,
        'aupr': k700_aupr_score,
        'fpr95': k700_fpr95,
    }))
save_roc_curve(fpr, tpr, './result/images/k400_vs_k700/cw_maha_auroc.png')
save_precision_recall_curve(pr, re, './result/images/k400_vs_k700/cw_maha_aupr.png')
