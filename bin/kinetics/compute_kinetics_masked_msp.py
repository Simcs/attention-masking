...
def compute_msp_ood_scrores(args):
    ...
    measure_performances(k400_msp, k600_msp)
    ...
    id_label, ood_label, detector = 'K400', 'K600_excl', 'MSP'
    save_histogram(
        id=k400_msp, 
        ood=k600_msp, 
        id_label=id_label, 
    ...
    measure_performances(k400_msp, k700_msp)
    ...
    id_label, ood_label, detector = 'K400', 'K700_excl', 'MSP'
    save_histogram(
        id=k400_msp, 
        ood=k700_msp, 
        id_label=id_label, 
