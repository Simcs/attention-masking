...
def compute_masked_statistics(args):
    ...
    filename = Path('./data/kinetics/embeddings/masked/k400_train/spatiotemporal_max_0.5_lt_threshold_0.01_lt_threshold_0.05.jsonl')
    ...
    for c in tqdm(correct_penultimates.keys()):
