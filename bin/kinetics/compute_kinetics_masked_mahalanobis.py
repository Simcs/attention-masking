...
def compute_mahalanobis_ood_scores(args):
    ...
    stat_fn = 'data/kinetics/statistics/masked/k400_train/spatiotemporal_max_0.5_lt_threshold_0.01_lt_threshold_0.05_statistics_total.pkl'
    # stat_fn = stat_fn.parent / f'{stat_fn.stem}_statistics_total.pkl'
    # stat_fn = '/home/simc/workspace/OOD-with-ViT/data/kinetics/k400_train_statistics_total.pkl'
    ...
    # k400_embeddings_filename = './data/kinetics/embeddings/masked/k400_val/spatiotemporal_max_0.5_lt_threshold_0.01_lt_threshold_0.05.jsonl'
    ...
    # k600_embeddings_filename = '/home/simc/workspace/OOD-with-ViT/data/kinetics/embeddings/masked/k600_val/spatiotemporal_max_0.5_lt_threshold_0.01_random_None_random_deduplicated.jsonl'
    # k600_embeddings_filename = './data/kinetics/embeddings/masked/k600_val/spatiotemporal_max_0.5_lt_threshold_0.01_random_None_skip.jsonl'
    # k600_embeddings_filename = './data/kinetics/embeddings/masked/k600_val/spatial_max_0.5_lt_threshold_0.01.jsonl'
    k600_embeddings_filename = './data/kinetics/embeddings/masked/k600_val/spatiotemporal_max_0.5_lt_threshold_0.01_random_None_random.jsonl'
    k600_embeddings_filename = k600_emb_fn.parent / (k600_emb_fn.stem + '_deduplicated' + k600_emb_fn.suffix)
    print('k600:', k600_embeddings_filename)
    k600_original = []
    ...
    # k700_embeddings_filename = '/home/simc/workspace/OOD-with-ViT/data/kinetics/embeddings/masked/k700-2020_val/spatiotemporal_max_0.5_lt_threshold_0.01_random_None_random_deduplicated.jsonl'
    # k700_embeddings_filename = '/home/simc/workspace/OOD-with-ViT/data/kinetics/embeddings/masked/k600_val/spatiotemporal_max_0.5_lt_threshold_0.01_random_None_random_deduplicated.jsonl'
    # k700_embeddings_filename = './data/kinetics/embeddings/masked/k700-2020_val/spatiotemporal_max_0.5_lt_threshold_0.01_random_None_skip.jsonl'
    # k700_embeddings_filename = './data/kinetics/embeddings/masked/k700-2020_val/spatial_max_0.5_lt_threshold_0.01.jsonl'
    k700_embeddings_filename = './data/kinetics/embeddings/masked/k700-2020_val/spatiotemporal_max_0.5_lt_threshold_0.01_random_None_random.jsonl'
    k700_embeddings_filename = k700_emb_fn.parent / (k700_emb_fn.stem + '_deduplicated' + k700_emb_fn.suffix)
    print('k700:', k700_embeddings_filename)
    k700_original = []
    ...
    # print('computing gaussian scores finished.')
        ...
        k700_maha, _ = k700_gaussian_scores.min(dim=1)
        k700_mahalanobis_distances.extend(k700_maha.numpy())
