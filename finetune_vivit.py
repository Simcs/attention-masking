...
from video_transformer.model_trainer import VideoTransformer
import video_transformer.data_transform as T
from video_transformer.utils import print_on_rank_zero

from ood_with_vit.utils.vivit_trainer import MaskedVideoTransformer
from ood_with_vit.utils.ucf101_data_module import UCF101DataModule
from ood_with_vit.utils.hmdb51_data_module import HMDB51DataModule
...
def parse_args():
    ...
    # attention masking
    parser.add_argument(
        "-attention_masking", action="store_true",
    )
    parser.add_argument(
...
def single_run(config):
    ...
    exp_tag = 'vivit_pretrained_ucf101'
