...
from ood_with_vit.datasets.ucf101 import VideoOnlyUCF101, IndexUCF101
...
class UCF101DataModule(pl.LightningDataModule):
	...
	def get_dataset(self, annotation_path, transform, train, fold, temporal_sample=None):
		ucf101_root = '~/workspace/dataset/ucf101'
		...
		with open(f'./data/ucf101/metadata/ucf101_{fold}_{split}_metadata.pkl', 'rb') as f:
			metadata = pickle.load(f)
  
		if not self.configs.attention_masking:
			dataset = VideoOnlyUCF101(
				root=ucf101_root,
